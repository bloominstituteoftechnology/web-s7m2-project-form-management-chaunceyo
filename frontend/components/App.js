...
export default function App() {
  ...
  const onChange = evt => {
    ...
    //return console.log(`Changed input: ${evt.target.id} Changed value: ${evt.target.value}`)
  ...
  const submitNewMember = () => {
    ...
    const newMember = {fname: formValues.fname, lname: formValues.lname, bio: formValues.bio, id: getId()}
